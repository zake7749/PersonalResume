...
a script that replaces the top window — the old site was a frameset, so a page
may still be opened inside a frame from an old link.

The original pages remain in the history, up to `b7e539c`.
